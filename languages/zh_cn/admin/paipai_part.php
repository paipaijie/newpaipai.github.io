...
$_LANG['paipai_part_list'] = '拍拍活动时间段列表';
$_LANG['add_part'] = '添加拍拍活动时间段';
$_LANG['paipai_part_add'] = '添加拍拍活动时间段';

$_LANG['paipai_part'] = '时间场次：';
$_LANG['notice_part'] = '场次为整点，格式为：9:00';

$_LANG['show'] = '是否显示';

$_LANG['js_languages']['error_paipai_part'] = '请填写时间段！';


$_LANG['back_list'] = '返回拍拍活动时间段列表。';
$_LANG['continue_add'] = '继续添加拍拍活动时间段。';
$_LANG['add_success'] = '添加拍拍活动时间段成功。';
$_LANG['error_symbol'] = '错误的冒号(:)符号,请使用英文冒号';
